...
! function($) {
    ...
    MorrisCharts.prototype.createLineChart = function(element, data, xkey, ykeys, labels, lineColors) {
        ...
        MorrisCharts.prototype.init = function() {
            ...
            var $donutData = [
                { label: "Pending Order", value: 10 },
                { label: "Schedule Order", value: 10 },
                { label: "Processing Order", value: 10 }
            ];
            this.createDonutChart('morris-donut-example', $donutData, ['#4bbbce', '#5985ee', '#46cd93']);

            //creating donut chart Dark
            var $donutData1 = [
                { label: "Pending Order", value: 12 },
                { label: "Schedule Order", value: 30 },
                { label: "Processing Order", value: 20 }
            ];
