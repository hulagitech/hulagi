...
class TokenController extends Controller
{
     ...
     public function register(Request $request)
    {
        ...
        try{
            ...
            //mass assignment = ProviderService::create(['provider_id' => $Provider->id]);
            ...
            $service_types = explode(',',$request->service_type_ids);
            foreach ($service_types as $key => $service_type) {
                $providerServices = new ProviderService;
                $providerServices->provider_id = $Provider->id;
                $providerServices->service_type_id = $service_type;
                $providerServices->status = 'active';
                $providerServices->service_number = $request->service_number;
                $providerServices->service_model = $request->service_model;
 ...
 /**
    ...
    {
        $pending=UserRequest::where('status','PENDING')->groupby('user_id')->get();
        return $pending;
    }
}
