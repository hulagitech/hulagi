...
class ProviderDocumentResource extends Controller
{
    ...
    public function index(Request $request, $provider)
    {
        ...
        try {
			...
			if(Auth::guard('dispatcher')->user()){
                return view('dispatcher.providers.document.index', compact('Provider', 'ServiceTypes','ProviderService', 'pr_documents'));    
            }
            if(Auth::guard('bm')->user()){
                return view('bm.providers.document.index', compact('Provider', 'ServiceTypes','ProviderService', 'pr_documents'));    
            }
    ...
    public function store(Request $request, $provider)
    {
        ...
        if(Auth::guard('dispatcher')->user()){
            return redirect()->route('dispatcher.provider.document.index', $provider)->with('flash_success', 'Driver vehicle type updated successfully!');
        }
        if(Auth::guard('bm')->user()){
            return redirect()->route('bm.provider.document.index', $provider)->with('flash_success', 'Driver vehicle type updated successfully!');
        }
    ...
    public function edit(Request $request, $provider, $id)
    {
        ...
        try {
            ...
            if(Auth::guard('bm')->user()){
                return view('bm.providers.document.edit', compact('Document'));
            }
            ...
            if(Auth::guard('bm')->user()){
                return redirect()
                ->route('bm.provider.document.index', $provider)
                ->with('flash_error', $e->getMessage() );
            }
            return redirect()
    ...
    public function get_provider_document_upload(Request $request, $provider,$id) {
	    ...
	    try {
			...
			if(Auth::guard('dispatcher')->user()){
                return view('dispatcher.providers.document.create', compact('Document','Provider'));
            }
            if(Auth::guard('bm')->user()){
                return view('bm.providers.document.create', compact('Document','Provider'));
            }
	...
	public function edit_provider_document_upload(Request $request, $provider,$id) {
	    ...
	    try {
			...
			if(Auth::guard('dispatcher')->user()){
                return view('dispatcher.providers.document.editdata', compact('Document'));
            }
            if(Auth::guard('bm')->user()){
                return view('bm.providers.document.editdata', compact('Document'));
            }
	...
	public function provider_document_upload(Request $request,$provider ) {
        ...
        if(Auth::guard('dispatcher')->user()){
            return redirect()
                ->route('dispatcher.provider.document.index', $provider)->with('flash_success', 'Driver document has been inserted.');
        }
        if(Auth::guard('bm')->user()){
                    return redirect()
                        ->route('bm.provider.document.index', $provider)->with('flash_success', 'Driver document has been inserted.');
        }
        return redirect()
