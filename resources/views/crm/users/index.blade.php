...
<div class="content-area py-1">
   <div class="container-fluid">
      ...
      <div class="box box-block bg-white">
         ...
         <hr>
         <a href="{{ route('crm.user.create') }}" style="margin-left: 1em;" class="btn btn-success pull-right btn-rounded btn-secondary"><i class="fa fa-plus"></i> Add New</a>
               ...
               <tr>
                  ...
                  <td>
                    <form action="{{ route('crm.user.destroy', $user->id) }}" method="POST">
                        ...
                        <a href="{{ route('crm.user.request', $user->id) }}" class="btn btn-black btn-secondary"><i class="fa fa-search"></i> </a>
                        <a href="{{ route('crm.user.edit', $user->id) }}" class="btn btn-success btn-secondary"><i class="fa fa-pencil"></i> </a>
                        <!--change by 101-->
