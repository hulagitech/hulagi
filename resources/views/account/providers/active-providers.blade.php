        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h4 class="page-title m-0">Total Rider Working</h4>
                    </div>
								...
								@foreach($Providers as $index => $provider)
									<tr>
										...
										<td style="text-align:center">
																		...
																		@if(@$provider->status == 'approved')
																		<a   onclick="return confirm('Are you sure, you want to ban this rider?')" href="{{ route('account.provider.disapprove', $provider->id ) }}"><span class="btn btn-secondary btn-success " style="width:5cm"><i class="fa fa-ban"></i></span></a>
																		@else
																		<a  onclick="return confirm('Are you sure, you want to unban this rider?')" href="{{ route('account.provider.approve', $provider->id ) }}"><span class="btn btn-secondary btn-success " style="width:5cm"><i class="fa fa-check"></i></span></a>
																		@endif
											...
											<div class="btn-group" role="group">
												<button type="button" class="btn btn-secondary btn-secondary btn-rounded btn-black waves-effect dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
													Action
												</button>
