...
<body class="fixed-sidebar fixed-header content-appear skin-1">
    ...
    <div class="wrapper">
        ...
        @include('fulfillment.layout.partials.header')
        @include('fulfillment.layout.partials.nav')
        
        <div class="page-content dashboard-page">  
            <div class="site-content no-margin">
                @include('common.notify')
                @yield('content')
                @include('fulfillment.layout.partials.footer')
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).find(".hamburger").trigger("click");
        }); 
