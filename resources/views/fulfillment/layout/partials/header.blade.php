		...
		<div class="container-fluid">
			...
			<div class="col-sm-2 col-xs-2">
				<div class="navbar-left" style="background-color: #fff;">
					<a class="navbar-brand" href="{{url('fulfillment/dashboard')}}" style="background:white;">
					<div class="logo">
						...
						<li class="nav-item dropdown hidden-sm-down">
							<a href="#" data-toggle="dropdown" aria-expanded="false">
								<span class="avatar box-32">
									 ...
									 @if(isset(\Auth::guard('fulfillment')->user()->picture))
				                     <img src="{{img(\Auth::guard('fulfillment')->user()->picture)}}" alt="">
				                     @else
							...
							<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
								<a class="dropdown-item" href="{{route('fulfillment.profile')}}">
									<i class="ti-user mr-0-5"></i> Profile
								</a>
								<a class="dropdown-item" href="{{route('fulfillment.password')}}">
									<i class="ti-settings mr-0-5"></i> Change Password
								</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="{{ url('/fulfillment/logout') }}"
