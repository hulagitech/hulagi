@extends('fulfillment.layout.auth')
...
<div>
    <div class="row">
        <div class="col-md-4">
            <div class="box b-a-0" style="top: 132px; box-shadow: none;height: 448px;">
                <div class="p-2 text-xs-center">
                    <h2>Fulfillment Panel Login</h2>
                </div>
                <form class="form-material mb-1" role="form" method="POST" action="{{ url('/fulfillment/login') }}" >
                {{ csrf_field() }}
        ...
        <div class="col-md-8">
        <img src="{{asset('asset/front_dashboard/img/login.jpg')}}" alt="Fulfillment Panel" style="width: 100%;">
        </div>
    </div>
</div>
@endsection
