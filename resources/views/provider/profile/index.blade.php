                                    ...
                                    <form class="profile-form" action="{{route('provider.profile.update')}}" method="POST" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="prof-form-sub-sec">
                                            <div class="col-xs-12 col-md-6">
                                                <button type="submit" class="btn btn-block btn-success btn-secondary" style="margin-left: -15px;">Update</button>
                                            </div>
                                            <div class="col-xs-12 col-md-6">
                                                <a href="{{url('provider/profile')}}" class="btn btn-block btn-danger btn-secondary" style="margin-left: -15px;">Cancel</a>
                                            </div>
                                        </div>
                                        <!-- End of prof-sub-sec -->
