                                          ...
                                          <table class="center" cellpadding="0" cellspacing="0">
                                             <tr>
                                                <td style="line-height:0;">
                                                   <a target="_blank" style="text-decoration:none;" href="{{  url('/') }}" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left" vspace="0" hspace="0" width="113" height="12" /><img src="{{ url('/public/uploads/77806a2011a93ab9bca8975443c7a0db96f6cbea.png') }}" width="116px"/></a>
                                                </td>
                                             </tr>
                                          </table>
                                       </th>
                                          ...
                                          <table width="100%" cellpadding="0" cellspacing="0">
                                             <tr>
                                                <td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="font:bold 13px/15px Arial, Helvetica, sans-serif; color:#888;">
                                                   <a target="_blank" style="text-decoration:none; color:#888;" href="#"></a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="#"></a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="http://97pixelsdev.com/ilyft/support/complaint">Support</a>
                                                </td>
                                             </tr>
                                          </table>
                                       </th>
                                    ...
                                    <tr>
                                       <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:bold 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                          <table>
                                             ...
                                             <tr>
                                                <td>From &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                                <td>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;{{ $user['s_address'] }}</td>
                                             </tr>
                                             <tr>
                                                <td>To &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                                <td>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;{{ $user['d_address'] }}</td>
                                             </tr>
                                          </table>
                                          <br/><br/><br/><br/><br/>
                                          ...
                                          2019 www.ilyft.com
                                          <br/><br/>
                                          <b>Disclaimer:</b> You are receiving this email because your friend or someone suggest your email . If you don't want to receive such emails in the future, please change your notification settings.  
                                       </td>
                                    </tr>
                                    <tr>
                                          ...
                                          <table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                                             ...
                                             <tr>
                                                <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" >
                                                   <a style="text-decoration:none;  padding:12px 10px 10px;" href="#"><img src="http://97pixelsdev.com/ilyft/asset/front_dashboard/img/facebook.png" alt="facebook" target="_blank"></a>
                                                   <a style="text-decoration:none;  padding:12px 10px 10px;" href="#"><img src="http://97pixelsdev.com/ilyft/asset/front_dashboard/img/google-plus.png" alt="google" target="_blank"></a>
                                                   <a style="text-decoration:none;  padding:12px 10px 10px;" href="#"><img src="http://97pixelsdev.com/ilyft/asset/front_dashboard/img/twitter.png" alt="twitter" target="_blank"></a
                                                </td>
                                             </tr>
                                          </table>
                                       </td>
