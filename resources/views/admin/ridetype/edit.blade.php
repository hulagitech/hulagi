                    ...
                    <div class="col-xs-10">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <button type="submit" class="btn btn-success btn-secondary btn-block" disabled="disabled">Update</button>
                            </div>
                            <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                                <a href="{{ route('admin.ridetype.index') }}" class="btn btn-danger btn-secondary btn-block">Cancel</a>
                            </div>
