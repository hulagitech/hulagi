...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
           <h5 style="margin-bottom: 2em;"><i class="ti-car"></i>&nbsp;Update Category</h5><hr>
            ...
            <form class="form-horizontal" action="{{url('admin/service_update',$service->id)}}" method="POST" enctype="multipart/form-data" role="form" file="true">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="{{ $service->capacity }}" name="capacity" required id="capacity" placeholder="Capacity">
                    </div>
                </div>
                    ...
                    <div class="col-xs-10">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                                <a href="{{ route('admin.service.index') }}" class="btn btn-danger btn-secondary btn-block">Cancel</a>
                            </div>
