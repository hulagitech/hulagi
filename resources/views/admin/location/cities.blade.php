    ...
    <div class="content-area py-1" id="zoneModel">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <a href="{{ route('admin.location.create') }}" style="margin-left: 1em;" class="btn btn-secondary btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Add City</a>
                        ...
                        <tr v-for="(city,index) in cities">
                            ...
                            <td>
                                <form :action="'{{url('admin/city')}}/'+city.id" method="POST">
                                    ...
                                    <input type="hidden" name="_method" value="DELETE">
                                    <a :href="'{{url('admin/city')}}/'+city.id+'/edit'" class="btn btn-secondary btn-success"><i class="fa fa-edit"></i></a>
