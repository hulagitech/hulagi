...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <!-- <a href="{{ route('admin.minizone.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a> -->

			<h5 style="margin-bottom: 2em;"><span class="s-icon"><i class="ti-zoom-in"></i></span>&nbsp;Update  Zone</h5><hr>

            <!--form class="form-horizontal" action="{{route('admin.minizone.update', $zone->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
