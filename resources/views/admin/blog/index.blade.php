...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <a href="{{ route('admin.blog.create') }}" style="margin-left: 1em;" class="btn btn-secondary btn-rounded btn-success pull-right"><i class="fa fa-plus"></i>Add New</a>
            <a href="{{ url('/blogs') }}" style="margin-left: 1em;" class="btn btn-secondary btn-rounded btn-success pull-right" target="_blank"><i class="fa fa-plus"></i>View Blog</a>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px">
                            <form action="{{ route('admin.blog.destroy', $service->id) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                               <a href="{{ route('admin.blog.edit', $service->id) }}" class="btn btn-success btn-secondary">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <button class="btn btn-danger btn-secondary" onclick="return confirm('Are you sure?')">
