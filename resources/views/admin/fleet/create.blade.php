...
@section('title', 'Add Delivery Agency')
...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;"><span class="s-icon"><i class="ti-rocket"></i></span>&nbsp; Add Delivery Agency</h5>
			<hr/>
            <form class="form-horizontal" action="{{route('admin.fleet.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="company" class="col-xs-12 col-form-label">Delivery Agency Name</label>
					<div class="col-xs-12">
						<input class="form-control" type="text" value="{{ old('company') }}" name="company" required id="company" placeholder="Delivery Agency Name">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="logo" class="col-xs-12 col-form-label">Delivery Agency Logo</label>
					<div class="col-xs-12">
				...
				<div class="form-group row">
					...
					<div class="col-xs-12">
						<button type="submit" class="btn btn-success btn-secondary">Add Delivery Agency</button>
