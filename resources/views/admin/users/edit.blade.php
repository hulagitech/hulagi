...
@section('content')
                ...
                <div class="card-body">
                    <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row form-group align-items-center">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $user->discount_percentage }}"
                                    name="discount" required id="discount" placeholder="Enter Discount Percentage">
                            </div>
                        </div>
                        ...
                        <div class="row form-group align-items-center">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $user->remarks }}" name="remarks"
                                    id="remarks" placeholder="Please Enter Your name if you have done the agreement">
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.changeuserpassword') }}" method="POST" enctype="multipart/form-data"
                        role="form">
                        {{ csrf_field() }}
