         ...
         <div class="col-sm-2 col-xs-2">
            <div class="navbar-left" style="background-color: #fff;">
                <a class="navbar-brand" href="{{url('admin/dashboard')}}" style="background:white;">
                  <div class="logo">
                     <img  style="width: 110px;height: 40px;" src=" {{ asset(Setting::get('site_logo')) }}">
                  </div>
                </a>
         ...
         <div class="col-sm-9 col-xs-9">
            <div class="navbar-right navbar-toggleable-sm collapse" id="collapse-1">
               <ul class="nav navbar-nav float-md-right">
                  ...
                  {{-- Admin Comment notification icon --}}
                  <li class="nav-item dropdown">
                     <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false">
                     <i class="ti-comment"></i>
                     {{-- <span class="hidden-md-up ml-1">Trip</span> --}}
                     {{-- <span class="tag tag-danger top">1</span> --}}
                     <span class="tag tag-danger top">{{Auth::user()->unreadAdmin()}}</span>
                     </a>
                     <div class="dropdown-tasks dropdown-menu dropdown-menu-right animated fadeInUp">
                        
                        <div class="t-item">
                           <div class="mb-0-5">
                              <a class="text-black" href="#">Notification Under Construction</a>
