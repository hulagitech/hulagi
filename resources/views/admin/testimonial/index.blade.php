    ...
    <div class="content-area py-1">
        ...
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <a href="{{ route('admin.testimonial.create') }}" style="margin-left: 1em;" class="btn btn-secondary btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Add New</a>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px">
                                        ...
                                        <form action="{{ route('admin.testimonial.destroy', $testimonial->id) }}" method="POST">
                                            ...
                                            <a href="{{ route('admin.testimonial.edit', $testimonial->id) }}" class="btn btn-secondary btn-success"><i class="fa fa-pencil"></i></a>
