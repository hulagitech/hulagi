...
<div class="content-area py-1">
   <div class="container-fluid">
      <div class="box box-block bg-white">
         ...
         <hr>
         <a href="{{ route('admin.cms-manager.create') }}" style="margin-left: 1em;" class="btn btn-secondary btn-rounded btn-success pull-right"><i class="fa fa-plus"></i> Add New</a>
               ...
               <tr>
                  ...
                  <td>
                     <form action="{{ route('admin.cms-manager.destroy', $cms->id) }}" method="POST">
                        ...
                        <a href="{{ route('admin.cms-manager.edit', $cms->id) }}" class="btn btn-secondary btn-success"><i class="fa fa-pencil"></i></a>
