   ...
   <div class="col-sm-12">
      <div class="page-title-box">
            <div class="row align-items-center">
               <div class="col-md-8">
                  <h4 class="page-title m-0">Add Location </h4>
               </div>
               <div class="col-md-4">
...
function initialize() {
  ...
  searchBox.addListener('places_changed', function() {
    ...
    if( edit_polygon ) {
        ...
        all_zones.forEach(myFunction)
      function myFunction(item, index, arr) {
           arr = item['latlng'];
          //  console.log(arr);
           var edit_poly_options = { fillColor: '#BCDCF9', fillOpacity: 0.0, strokeWeight: 2, strokeColor: '#e30909', zIndex: 1  };
          edit_poly_options.paths = makeZoneArray( arr );
          var shape = new google.maps.Polygon( edit_poly_options ); 
          shape.setMap(map);
      }
    ...
    }else
    {
      ...
      function myFunction(item, index, arr) {
        ...
        //    console.log(content);
          //  console.log(arr);
           var edit_poly_options = { fillColor: '#BCDCF9', fillOpacity: 0.0, strokeWeight: 2, strokeColor: '#57ACF9', zIndex: 1,content:content };
          edit_poly_options.paths = makeZoneArray( arr );
          var shape = new google.maps.Polygon( edit_poly_options ); 
          shape.setMap(map);
