...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <a href="{{ route('admin.fare.settings.create') }}" style="margin-left: 1em;" class="btn btn-secondary btn-success btn-rounded pull-right"><i class="fa fa-plus"></i> Add New Plan</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.fare.settings.destroy') }}" method="POST">
                                ...
                                <a href="{{ route('admin.fare.settings.edit',$service->id) }}" class="btn btn-success btn-secondary">
