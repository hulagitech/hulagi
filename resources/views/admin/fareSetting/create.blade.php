...
<!--{{ route('admin.fare.settings.store') }}-->
            <form class="form-horizontal"  action="{{ route('admin.fare.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="" name="price_per_km"  id="price_per_km" onkeypress="javascript:return isValid(this,event)">
					</div>
				</div>
				...
				<div class="form-group row">
                    <div class="col-xs-12 col-sm-6 offset-md-2 col-md-3">
                    	<button type="submit" class="btn btn-success btn-secondary" id="alertbox">Save</button>
                    	<a href="{{route('admin.fare_settings')}}" class="btn btn-danger btn-secondary">Cancel</a>
