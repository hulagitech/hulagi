        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                ...
                <form action="{{ route('fleet.provider.document.store', $Provider->id) }}" method="POST">
                    ...
                    <div class="col-xs-3">
                        <button class="btn btn-success btn-secondary btn-block" type="submit">Update</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group-btn">
                                <a href="{{ route('fleet.provider.document.edit', [$Provider->id, $Document->id]) }}"><span class="btn btn-success btn-large btn-secondary">View</span></a>
                                <button class="btn btn-danger btn-secondary btn-large" form="form-delete">Delete</button>
