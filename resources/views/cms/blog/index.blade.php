...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <a href="{{ route('cms.blog.create') }}" style="margin-left: 1em;" class="btn btn-success btn-secondary btn-rounded pull-right"><i class="fa fa-plus"></i>Add New</a>
            <a href="{{ url('/blogs') }}" style="margin-left: 1em;" class="btn btn-success btn-secondary btn-rounded pull-right" target="_blank"><i class="fa fa-plus"></i>View Blog</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('cms.blog.destroy', $service->id) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <a href="{{ route('cms.blog.edit', $service->id) }}" class="btn btn-success btn-secondary">
