...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <a href="{{ url('dispatcher/provider/'.$Provider[0]['id'].'/document') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a>
			
			<h5 style="margin-bottom: 2em;">Add Driver Document</h5>

		
            <form class="form-horizontal" action="{{ url('dispatcher/provider/'.$Provider[0]['id'].'/document/'.$Document[0]['id'].'/upload') }}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
            ...
            <h5 class="mb-1">Document: {{ $Document[0]['name'] }}</h5>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{ url('dispatcher/provider/'.$Provider[0]['id'].'/document') }}" class="btn btn-default">Cancel</a>
					</div>
				</div>
			</form>
