  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="content-area py-1">
        <div class="container-fluid">
    	  <div class="">
		   <form action="{{url('/dispatcher/dispatcher/create/item')}}" method="POST" id="item_create" enctype="multipart/form-data">
...
function  itemSubmit(){ 
        ...
        var  url     ="<?php echo url('/dispatcher/dispatcher/create/item');?>";
