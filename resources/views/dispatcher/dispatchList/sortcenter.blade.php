					...
					<div class="collapse navbar-toggleable-sm" id="process-filters">
						<ul class="nav navbar-nav dispatcher-nav">
                            <li class="nav-item dispatcher-tab">
                                <a href={{url("dispatcher/sortcenter")}}><span class="nav-link dispatcher-link">Sortcenter</span></a>
							</li>
						</ul>
					</div>
				</nav>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                <div class="box box-block bg-white">
                    <h5 class="mb-1"> <i class="fa fa-recycle"></i> Sortcenter</h5>
                    <hr/>
                            ...
                            <tr id="dataRow{{$index}}">
                                ...
                                <td>
                                    @if(@$request->provider)
                                        ...
                                        <select class='txtedit' id='provider-{{$request->id}}'>
                                            <option>N/A</option>
                                        ...
                                        {{--<input type='text' class='txtedit' value="{{@$request->status}}" id='status-{{$request->id}}'>--}}
                                    @else
                                        <div class='edit'>
                                        N/A
                                        </div>
