                        ...
                        @foreach($requests as $index => $request)
                            <tr id="dataRow{{$index}}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dispatcher.dispatchList.editDraft', @$request->id) }}" class="btn btn-warning">
                                        <i class="fa fa-pencil"></i>

                                    </a>
                                    <a href="{{ route('dispatcher.dispatchList.draftClear', @$request->id) }}" class="btn btn-danger">
                                        Receive</a>
                                </td>
                            </tr>
                        @endforeach
