...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Sortcenter Orders Today</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-pink mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Deliverying Orders Today</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Rejected Orders Today</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-info mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Scheduled Orders Today</h6>
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Total Sortcenter Orders</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-info mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Total deliverying Orders</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Total Scheduled Orders</h6>
	...
	<div class="col-xl-4">
		<div class="card">
			<div class="card-body">
				<h4 class="mt-0 header-title mb-4"><a href="{{url('sortcenter/sortcenterUnsolveComment')}}" style="color: black;">Unslove Sortcenter Comment</a></h4>
					...
					@if ($loop->iteration == 3) 
							...
							@endif
					@endforeach
					<div class=text-right><a href="{{url('sortcenter/sortcenterUnsolveComment')}}">View more</a></div>
					@else
					<li class="feed-item">
						<div class="feed-item-list">
	...
	<div class="col-xl-4">
		<div class="card">
			<div class="card-body">
				<h4 class="mt-0 header-title mb-4"><a href="{{url('sortcenter/opentickets')}}" style="color: black;">Recent Ticket</a></h4>
				<ol class="activity-feed mb-0">
					@if(count($tickets)>0)
					...
					<li class="feed-item">
						<div class="feed-item-list">
							...
							<span class="activity-text text-white"><a href="{{ url('sortcenter/ticket_comment/' . $comment->id) }}"
					...
					@if ($loop->iteration == 3) 
							...
							@endif
					@endforeach
					<div class=text-right><a href="{{url('sortcenter/opentickets')}}">View more</a></div>
					@else
					<li class="feed-item">
						<div class="feed-item-list">
							<span class="date text-white-50"></span>
			...
			<div class="card-body">
				...
				<div class="row mt-5">
					...
					<div class="col-md-4">
						<div class="social-source text-center mt-3">
							<div class="social-source-icon mb-2">
							<a href="https://www.instagram.com/hulagideliveryp/?hl=en" target="_blank" rel="noopener noreferrer"> <i class="mdi mdi-instagram h5 bg-pink text-white"></i></a>
							</div>
...
<div class="row">
     <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title mb-4">Recent Sortcenter Order</h4>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="underline">
                                    <a href="{{ url('/sortcenter/show/'.$ride->id) }}"  class="btn btn-dark ">
                                        Details
                                    </a>
                                </span>
