        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0"><i class="fa fa-recycle"></i>Outbound Orders</h4>
                    </div>
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-box bg-white">
                    ...
                    <form id="dispatchForm" method="POST" action="{{ url('sortcenter/outbound') }}" method="POST"
                        class="px-2">
                        {{ csrf_field() }}
                        <label>Orders</label>
                        ...
                        <button type="button" class="btn btn-success mb-1" id="btn1">Dispatch</button>
