        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-sm-6">
                        <span class="btn btn-warning">On Hold</span>
                    </div>
                    @else
                        <div class="col-sm-6">
                        <form method="post" action="{{route('sortcenter.hold')}}"  >
                            @csrf
                            <input type="hidden" name ="hold_id" value={{$request->id}} >
                            <button onclick="return confirm('Are you sure, you want Put this Order on Hold?')" type="submit" class="btn btn-danger">Hold</button>
                        </form>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 ">
                    ...
                    <div class="comment__container">
                        ...
                        <div class="m-4">
                            <form method="POST" action="{{ url('sortcenter/comments/' . $request->id) }}"
                                class='d-flex'>
                                {{ csrf_field() }}
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            const trip = <?php echo json_encode($request->status); ?>;
