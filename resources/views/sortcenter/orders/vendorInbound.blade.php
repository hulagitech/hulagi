        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">Inbound order</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form class=" form-inline"  method="POST"
                    action="{{ route('sortcenter.bulkinvocie') }}" target="_blank">
                    {{csrf_field()}}
                        ...
                        <tr id="dataRow{{$index}}">
                            ...
                            <td>
                                @if(@$inbound_order->user)
                                    ...
                                    {{ @$inbound_order->user->first_name }} <b>({{@$inbound_order->user->user_type}})</b>
                                @else
                                N/A
                                @endif
                            </td>
