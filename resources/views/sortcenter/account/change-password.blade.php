	...
	<div class="col-sm-12">
		<div class="page-title-box">
			<div class="row align-items-center">
				<div class="col-md-8">
					<h5 class="mb-1">
						<i class="ion ion-md-key"></i>&nbsp;Change password
					</h5>
				</div>
			</div>
...
<div class="content-area py-1">
	<div class="container-fluid">
		<div class="box box-block bg-white">
			...
			<form class="form-horizontal" action="{{route('sortcenter.password.update')}}" method="POST" role="form">
				{{csrf_field()}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-success btn-secondary">Change Password</button>
					</div>
				</div>
