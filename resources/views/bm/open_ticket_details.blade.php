...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <a href="{{ route('bm.openTicket') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a>

			<h5 style="margin-bottom: 2em;"><i class="ti-receipt"></i>&nbsp;Complaint Details</h5><hr>

            <form class="form-horizontal" action="{{route('bm.transfer', $data->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						...
						<a href="{{route('bm.openTicket')}}" class="btn btn-default">Cancel</a>
					</div>
				</div>
			</form>
		</div>
