...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/admin/assets/css/toastr.min.css') }}">
...
<body class="fixed-sidebar fixed-header content-appear skin-1">
    ...
    <div class="wrapper">
        ...
        @include('sortcenter.layout.partials.header')
		<div class="page-content dashboard-page">    
            <div class="site-content no-margin">
				@include('common.notify')
				@include('sortcenter.layout.partials.nav')
                @yield('content')
				@include('sortcenter.layout.partials.footer')
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript" src="{{asset('asset/admin/assets/js/toastr.min.js')}}"></script>
        <script>
