					...
					<div class="collapse navbar-toggleable-sm" id="process-filters">
						<ul class="nav navbar-nav bm-nav">
							<li class="nav-item bm-tab">
								<a href={{route("bm.dispatchList.pending")}}><span class="nav-link bm-link">Pending Receive</span></a>
							</li>
                            <li class="nav-item bm-tab">
								<a href={{url("bm/completeReceived")}}><span class="nav-link bm-link">Complete Received</span></a>
							</li>
                            <li class="nav-item bm-tab">
								<a href={{url("bm/incompleteReceived")}}><span class="nav-link bm-link">Rejected Received</span></a>
							</li>
                            <li class="nav-item bm-tab">
								<a href={{route("bm.dispatchList.returnDispatch")}}><span class="nav-link bm-link">Pending Receive(Returns)</span></a>
							</li>
                            {{-- <li class="nav-item bm-tab">
								<a href={{route("bm.dispatchList.pending")}}><span class="nav-link bm-link">Sortcenter</span></a>
							</li>	 --}}
						</ul>
					</div>
				</nav>
...
<script>
    $(document).ready(function(){
        $(".received").click(function(){
            ...
            $.ajax({
                url: "{{url('bm/dispatchList/eachReturnReceive')}}/"+edit_id,
                type: 'post',
