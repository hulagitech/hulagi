                    ...
                    <table id="datatable" class="table table-bordered"
                        ...
                        @foreach($requests as $index => $request)
                            <tr id="dataRow{{$index}}">
                                ...
                                <td>
                                    <a href="{{ route('bm.dispatchList.showReturnDispatch', $request->id) }}" class="btn btn-primary">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    {{-- <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('bm.dispatchList.showReturnDispatch', $request->id) }}" class="dropdown-item">
...
<script>
    $(document).ready(function(){
        $(".received").click(function(){
            ...
            $.ajax({
                url: "{{url('bm/dispatchList/pendingRejectedReceive')}}/"+edit_id,
                type: 'post',
