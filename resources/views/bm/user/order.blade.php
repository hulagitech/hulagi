...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="{{ url('bm/confirm/ride') }}" method="GET" id="confirm_ride"
    ...
    <script>
        $("#destination-phone").focusout(function(e) {
            ...
            if (destination_phone) {
                $.ajax({
                    url: '{{ url('bm/check-phone') }}/' + destination_phone,
                    method: "get",
...
?>;
    ...
    <script type="text/javascript">
        ...
        function itemSubmit() {
            showPleaseWait();
            var url = "<?php echo url('bm/create/item'); ?>";
        ...
        function get_fare() {
            var url = "<?php echo url('bm/get_fare'); ?>";
        ...
        function orderSubmit(getFare) {
            var url = "<?php echo url('bm/create/ride'); ?>";
            var user_id = $('#user_id').val();
            var s_latitude = $("#origin_latitude").val();
            var s_longitude = $("#origin_longitude").val();
            var d_latitude = $("#destination_latitude").val();
