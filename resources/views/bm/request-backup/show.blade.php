            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-lg-12"> -->
                        {{-- <!-- <form method="POST" action="{{ url('bm/comments/'.$request->booking_id) }}"> --> --}}
                        <form method="POST" action="{{ url('bm/comments/'.$request->id) }}">
                            {{ csrf_field() }}
                            <div class="col-lg-10">
                                <input type="text" name="bm_comment" id="bm_comment" class="form-control" placeholder="Add Your Comment ...">
                            </div>
                            <div class="col-lg-2">
