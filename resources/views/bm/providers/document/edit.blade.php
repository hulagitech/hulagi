...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <form action="{{ route('bm.provider.document.update', [$Document['provider_id'], $Document['document_id'] ]) }}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                ...
                <div class="col-xs-6">
                    <form action="{{ route('bm.provider.document.destroy', [$Document->provider_id, $Document['document_id']]) }}" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
