...
<div class="content-area py-1" id="bm-panel">
				 ...
				 <nav class="navbar navbar-light bg-white b-a mb-2">
					...
					<div class="collapse navbar-toggleable-sm" id="process-filters">
						...
						<ul class="nav navbar-nav bm-nav">
							...
							<li class="nav-item bm-tab active" id="dispatch-map" onClick="getUpdateFilterData('');" >

								<span class="nav-link bm-link">ALL</span>

							</li>

							<li class="nav-item bm-tab" id="dispatch-new" onClick="getUpdateFilterData('dispatch-new');">

								<span class="nav-link bm-link">PENDING</span>

							</li>

							<li class="nav-item bm-tab" id="dispatch-dispatching" onClick="getUpdateFilterData('dispatch-dispatching');">

								<span class="nav-link bm-link">DISPATCHING</span>

							</li>

							<li class="nav-item bm-tab" id="dispatch-completed" onClick="getUpdateFilterData('dispatch-completed');">

								<span class="nav-link bm-link">COMPLETED</span>

							</li>

							<li class="nav-item bm-tab" id="dispatch-cancelled" onClick="getUpdateFilterData('dispatch-cancelled');">

								<span class="nav-link bm-link" >CANCELLED</span>

							</li>

							<li class="nav-item bm-tab" id="dispatch-scheduled" onClick="getUpdateFilterData('dispatch-scheduled');">

								<span class="nav-link bm-link">SCHEDULED</span>

							</li>

							<li class="nav-item bm-tab" id="bm-dead" onClick="getUpdateFilterData('bm-dead');">

								<span class="nav-link bm-link">DEAD</span>

							</li>

							<li class="nav-item bm-tab" id="bm-log" onClick="getLogsData();">

								<span class="nav-link bm-link">LOGS</span>
    ...
    @include('bm.layout.partials.cancel_ride_form')

     

    @if( $companies->count() )

    	@include('bm.layout.partials.assign_form')
