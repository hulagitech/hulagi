	...
	<nav class="navbar navbar-light">
        ...
        <div class="col-sm-6 col-xs-6">
            <div class="navbar-left" style="background-color: #fff; display:flex;">
                <a class="navbar-brand" href="{{url('pickup/dashboard')}}" style="background:white;">
                    <div class="logo">
                        <img  style="width: 132px; height: 40px;" src=" {{ url(Setting::get('site_logo', asset('logo-black.png'))) }}">
                    </div>
                </a>
                <span style="width:200px; padding-top:20px;  font-size:22px; font-weight:bold; display:flex;"> &nbsp; - Pickup</span>
                        ...
                        <a href="#" data-toggle="dropdown" aria-expanded="false">
                            <span class="avatar box-32">
                                @if(isset(Auth::guard('admin')->user()->picture))
                                    <img src="{{img(Auth::guard('pickup')->user()->picture)}}" alt="">
                                @else
