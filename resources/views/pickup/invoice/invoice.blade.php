                    ...
                    <table style="width: 100%; " class="puryau_details">
                        <tr>
                            <td width="60%">
                                ...
                                <div> <i class="fa fa-map-marker"></i> &nbsp;&nbsp; Dillibazar, Ktm </div>
                                <div> <i class="fa fa-envelope-o"></i> &nbsp; hulagidelivery@gmail.com </div>
                                <div> <i class="fa fa-phone"></i> &nbsp; +01-15912257 @if($order->cargo)
