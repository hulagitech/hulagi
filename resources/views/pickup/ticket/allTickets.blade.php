        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">Pickup Ticket</h4>
                    </div>
                                ...
                                @foreach($tickets as $index => $ticket)
                                    <tr>
                                        ...
                                        <td style="position:relative;">
                                            <a href="{{ url('pickup/ticket_comment/'.$ticket->id) }}" class="btn btn-primary btn-secondary"><i class="ti-comment"></i></a>
                                        ...
                                        <td>
                                            <form method="POST" action="{{ url('pickup/close_ticket/' . $ticket->id) }}">
                                                ...
                                                <button type="submit" onclick="return confirm('Are you sure, you want to close?');"
                                                    class=" btn btn-success form-control">Close <i class="fa fa-ticket"></i></button>
                                            </form>
