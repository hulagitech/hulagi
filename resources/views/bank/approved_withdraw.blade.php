                ...
                @foreach($bank as $index => $service)
                    <tr>
                        ...
                        <td>
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <button class="btn btn-secondary btn-black btn-rounded w-min-sm m-b-0-25 waves-effect waves-light" data="{{ $service->id }}" id="approve_popup" onclick="approve_popup({{$service->id}});">
                                Details
                                </button>
