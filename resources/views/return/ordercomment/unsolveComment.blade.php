...
<div class="content-area py-1">
   <div class="container-fluid">
      <div class="box box-block bg-white">
      	<h5 class="mb-1">
            <i class="fa fa-comments"></i>&nbsp; Unsolve Order Comments
         </h5>
                ...
                @foreach($orderComments as $index => $orderComment)
                    <tr>
                        ...
                        <td style="position:relative;">
                            <a href="{{ url('return/oc_detail/'.$orderComment->request_id) }}" class="btn btn-success btn-secondary"> <i class="ti-comment"></i> </a>
