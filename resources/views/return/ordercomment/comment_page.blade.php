                        ...
                        <div class="col-md-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($user_req->comment_status=="0")
                                                        <form method="POST" action="{{url('return/solved/'.$user_req->id)}}">
                                                            {{ csrf_field() }}
                                                    ...
                                                    @else
                                                        <form method="POST" action="{{url('return/unsolve/'.$user_req->id)}}">
                                                            {{ csrf_field() }}
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-lg-12"> -->
                                    <form method="POST" action="{{ url('return/order_reply/'.$user_req->id) }}">
                                        {{ csrf_field() }}
                                        <div class="col-lg-10">
