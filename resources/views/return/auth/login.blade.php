...
@section('content')
 <div class="card mb-0">
        <div class="card-body">
            <div class="p-2">
                <h4 class="text-muted float-right font-18 mt-4">Return {{ trans('passengersignin.login') }}
                </h4>
                <div>
            ...
            <div class="p-2">
                <form method="POST" action="{{ url('/return/login') }}" class="form-horizontal m-t-20">
                    {{ csrf_field() }}
        ...
        <div class="col-md-4">
            <div class="box b-a-0" style="top: 132px; box-shadow: none;height: 448px;">
                <div class="p-2 text-xs-center">
                    <h2>Return User Login Panel</h2>
                </div>
                <form class="form-material mb-1" role="form" method="POST" action="{{ url('/return/login') }}" >
                {{ csrf_field() }}
