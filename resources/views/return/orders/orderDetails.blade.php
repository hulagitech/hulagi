        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                 ...
                 @if($request->status=="COMPLETED" && $request->exchange==0)
                            <div class="col-md-12">
                                <div class="float-right">
                                    <form action="{{ url('return/exchangeOrder') }}" method="post">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="trip_id" value="{{$request->id}}">
                                        <button type="submit" onclick="return confirm('Are you sure, you want to exchange  this Order ?')" class="btn btn-primary "><i class="ti-plus mr-1"></i>Exchange Order</button>
                                    </form>
                    ...
                    @if($request->exchange==1)
                        ...
                        <div class="float-right">
                            ...
                            <div class="btn btn-warning" type="button" id="exchangeOrder" >
                                <i class="ti-plus mr-1"></i>This Order is in Exchange
                            </div>
...
<div class="card">
    <div class="card-body">
        ...
        <article class="card content__card">
            ...
            @if (($request->status == 'ASSIGNED' || $request->status == 'DELIVERING' || $request->status == 'SCHEDULED')
            && $request->provider)
            <hr>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 ">
                    ...
                    <div class="comment__container">
                        ...
                        <div class="m-4">
                            <form method="POST" action="{{ url('return/comments/' . $request->id) }}"
                                class='d-flex'>
                                {{ csrf_field() }}
