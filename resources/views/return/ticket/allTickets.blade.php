                        ...
                        @foreach($tickets as $index => $ticket)
                            <tr>
                                ...
                                <td style="position:relative;">
                                   <a href="{{ url('return/ticket_detail/'.$ticket->id) }}" class="btn btn-success btn-secondary"><i class="ti-comment"></i></a>
                                ...
                                <td>
                                   <form method="POST" action="{{ url('return/close_ticket/' . $ticket->id) }}">
                                        {{ csrf_field() }}
