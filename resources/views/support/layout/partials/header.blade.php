	...
	<nav class="navbar navbar-light">
      ...
      <div class="col-sm-6 col-xs-6">
         <div class="navbar-left" style="background-color: #fff; display:flex;">
            ...
            <span style="width:200px; padding-top:20px;  font-size:22px; font-weight:bold; display:flex;"> &nbsp; - CS</span>
            ...
            <ul class="nav navbar-nav float-md-right">
               ...
               <li class="nav-item dropdown hidden-sm-down">
                  ...
                  <div class="dropdown-menu dropdown-menu-right animated fadeInUp">
                     ...
                     <a class="dropdown-item" href="{{ url('/support/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <i class="ti-power-off mr-0-5"></i> Sign out
                     </a>
                  </div>
               </li>
            </ul>
