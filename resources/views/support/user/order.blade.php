...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="{{ url('support/confirm/ride') }}" method="GET" id="confirm_ride"
                ...
                <div class="car-detail d-none" style="display:none;">
                ...
                <div class="form-group">
                    <select class="form-control " id="destination-weight" name="weight" required>
                ...
                <div>
                    <div class="custom">
                        <input type="checkbox" id="pnum">
                        <label class="custom-label" for="pnum">
                            <h6 class='mt-0'>Different pickup number</h6>
                        </label>
                    </div>
                </div>
                ...
                <!-- <div class="form-group row mb-0">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Orders placed before 12 PM will be delivered within same day. Order placed after 11 PM will be
    ...
    <script>
        $("#destination-phone").focusout(function(e) {
            ...
            if (destination_phone) {
                $.ajax({
                    url: '{{ url('support/check-phone') }}/' + destination_phone,
                    method: "get",
                    success: function(data) {
                        $('.receiver-stats').empty().html(
                            "<b class='text-success mr-1'> Accepted : </b>" + data.accepted +
                            "<b class='text-info ml-2'> Processing : </b>" + data.processing +
                            "<b class='text-danger ml-2'> Rejected : </b>" + data.rejected);
                    }
                });
            }
        });
...
?>;
    ...
    <script type="text/javascript">
        ...
        function itemSubmit() {
            showPleaseWait();
            var url = "<?php echo url('support/create/item'); ?>";
        ...
        function get_fare() {
            var url = "<?php echo url('support/get_fare'); ?>";
        ...
        function orderSubmit(getFare) {
            var url = "<?php echo url('support/create/ride'); ?>";
            var user_id = $('#user_id').val();
            var s_latitude = $("#origin_latitude").val();
            var s_longitude = $("#origin_longitude").val();
            var d_latitude = $("#destination_latitude").val();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if ($('#invoice').is(":checked")) {
                            var pickupDetails = {
                                CustomerName: "<?php echo $user->first_name; ?>",
                                CustomerAddressLine1: s_address,
                                CustomerPhno: "<?php echo $user->mobile; ?>",
                            };
                            var diff = cod - fare;
