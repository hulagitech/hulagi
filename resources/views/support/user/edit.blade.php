...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('support.user.update', $user->id) }}" method="POST"
                        ...
                        <div class="row form-group align-items-center justify-content-end">
                            <a href="{{ route('support.user.index') }}" class="btn btn-danger mr-2">Cancel</a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('support.changeuserpassword') }}" method="POST" enctype="multipart/form-data"
                        role="form">
                        {{ csrf_field() }}
