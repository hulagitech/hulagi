                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class=" d-flex row ">
                            ...
                            <div class="pl-5 row align-items-center">
                                <h6>Transfer Department: </h6>
                                <div class="edit pl-2">
                                    @if(@$request->dept_id!==0)
                                        <div style="color: maroon;"><b> {{@$request->dept->dept}} </b></div>
                                    @else
                                        <div style="color: maroon;"><b> Customer Service </b></div>
                                    @endif
                                </div>

                                <select class="txtedit col-md-3" id='department-{{$request->id}}'>
                                    @foreach ($depts as $dept)
                                        <option value="{{$dept->id}}" {{$request->dept_id==$dept->id?"selected":null}}> {{$dept->dept}} </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="m-4">
                                <form method="POST" action="{{ url('support/comments/' . $request->id) }}" class='d-flex'>
                                    {{ csrf_field() }}
