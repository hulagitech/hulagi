    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <h4 class="page-title m-0">Support Comments</h4>
                </div>
                   ...
                   {{-- {{ dd($allOrderComments)}} --}}
                    <tbody>
                        @foreach ($allOrderComments as $index => $allOrderComment)
                            @if ($allOrderComment->ur->dept_id == $dep||$allOrderComment->ur->dept_id == 0)
                                <tr>
                                    ...
                                    <td style="position:relative;">
                                        ...
                                        <a 
                                        href="{{route('support.order_details', $allOrderComment->request_id) }}"
                                        {{-- href="{{ url('support/allorder/comment/' . $allOrderComment->request_id) }}" --}}
