                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2">
                        @if ($ticket->status == 'open')
                            <form method="POST" action="{{ url('pickup/close_ticket/' . $ticket->id) }}">
                                {{ csrf_field() }}
                        ...
                        @else
                            <form method="POST" action="{{ url('pickup/open_ticket/' . $ticket->id) }}">
                                {{ csrf_field() }}
                ...
                <div class="card-body row">
                                    ...
                                    <div class="col-md-10 offset-md-0.5" s>
                                        ...
                                        <div>
                                            ...
                                            <div class="ticket-info">
                                                ...
                                                @if(@$ticket->dept_id!==0)
                                                <span class="sub-heading edit text-danger">{{ $ticket->dept->dept }}</span>
                                            @else
                                            <span class="sub-heading edit text-danger">{{ $ticket->department }}</span>
                                             
                                            @endif
                                                
                                                <select class="txtedit" id='department-{{$ticket->id}}'>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="comments__container">
                            ...
                            @endforeach
                            <form class='d-flex' method="POST" action="{{ url('support/ticket_reply/' . $ticket->id) }}">
                                {{ csrf_field() }}
