                        ...
                        <div class="col-md-12">
                                ...
                                <div style="background-color:#f5f5f5; padding:30px 20px 30px 20px;">
                                    <div class="from-to row no-margin">
                                        <table style="width:100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($user_req->comment_status=="0")
                                                        <form method="POST" action="{{url('support/solve_comment/'.$user_req->id)}}">
                                                            {{ csrf_field() }}
                                                    ...
                                                    @else
                                                        <form method="POST" action="{{url('support/unsolve_comment/'.$user_req->id)}}">
                                                            {{ csrf_field() }}
                                            ...
                                            <tr>
                                                <th><h6>Transfer Department: </h6></th>
                                                <td colspan="3">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-lg-12"> -->
                                    <form method="POST" action="{{ url('support/order_reply/'.$user_req->id) }}">
                                        {{ csrf_field() }}
                                        <div class="col-lg-10">
...
<script>
    function solve() {
        var txt;
        var su = confirm("Are you sure, Is that solved???");
        if(su == true){
            return true;
        } else {
            return false;
        }
        document.getElementById("notclick").innerHTML = txt;
    }

    function unsolve() {
        var txt;
        var su = confirm("Are you sure, Do you want to make unsolve???");
        if(su){
            return true;
        } else {
...
<script>
    $(document).ready(function(){
        ...
        $(".txtedit").focusout(function(){
            ...
            $.ajax({
                url: "{{url('support/edit_dept_order/')}}"+"/"+edit_id,
                type: 'post',
