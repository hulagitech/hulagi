...
@section('content')
    <div class="card mb-0">
        <div class="card-body">
            <div class="p-2">
                <h4 class="text-muted float-right font-18 mt-4">Support {{ trans('passengersignin.login') }}
                </h4>
                <div>
            ...
            <div class="p-2">
                <form method="POST" action="{{ url('/support/login') }}"  class="form-horizontal m-t-20">
                    {{ csrf_field() }}
