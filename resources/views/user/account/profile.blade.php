                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <h6 class="mb-0">VAT/PAN Number</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    {{ Auth::user()->VAT_PAN }}
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <h6 class="mb-0">Your Document</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    @if (isset(Auth::user()->Document))
                                        <img width="150" src=" {{ asset('storage/' . Auth::user()->Document) }}"
                                            alt="your document" width="150" />
                                    @endif
                                </div>
                            </div>
                            <hr>
