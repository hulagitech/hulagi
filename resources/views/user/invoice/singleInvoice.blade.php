        ...
        <div class="col-lg-12">
            <table width="100%" class="vr_details" >
                <tr>
                    ...
                    <td width="60%"> <img class="puryau-logo" style="position:absolute;top:-5px;left:1cm;" src=" {{ asset(Setting::get('site_logo')) }}"> </> </td>
                    <td width="20%"> 
                  </td>
                <td width="22%"> 
                         <div style="font-size:18px;"> <b>  {{ $order->created_at->format('Y-m-d') }}</b>  </div></td>
                </tr>
                ...
                <table style="width: 100%;" class="puryau_details">
                    <tr>
                        <td width="60%">
                            ...
                            <div> <i class="fa fa-envelope-o"></i> &nbsp; hulagilogisitcs@gmail.com </div>
