...
<div class="col-md-12" style="margin-bottom: 20px;">
    <div class="dash-content">
        <div class="row no-margin">
            <div class="col-md-12">
                <h4 class="page-title"><span class="s-icon"></span>&nbsp;New Order</h4><hr>
            </div>
        </div>
        ...
        <div class="row no-margin">
            <div class="col-md-6">
                ...
                {{ csrf_field() }}
					...
					<input type="hidden" name="cod" id="cod"  value="{{Request::get('cod')}}">
					<input type="hidden" name="special_note" id="special_note"  value="{{Request::get('special_note')}}">
					...
					<input type="hidden" name="item_id" id="item_id" value="{{Request::get('item_id')}}"/>									
                    ...
                    <div class="form-group promoc_wrap">    						
                        ...
                        <button  data-loading-text="Applying..."  style="width:30%; height: 34px!important" class="btn btn-success btn-secondary" id="promo_code_btn" type="button">Apply</button>					
                    </div>
		            <button type="submit" class="half-primary-btn btn-success btn-secondary fare-btn">@lang('user.ride.order_now')</button>
		            ...
		            <a class="full-primary-btn btn-danger btn-secondary" style="width: 647px;"  href="{{url('/trips')}}">@lang('user.ride.cancel_request')</a>
		            
		            <!--<button type="button" class="half-secondary-btn btn-danger btn-secondary" data-toggle="modal" data-target="#cancel_modal">@lang('user.ride.cancel_request')</button>-->
		            <!-- <button type="submit" class="half-primary-btn btn-success btn-secondary fare-btn">@lang('user.ride.order_now')</button>
                    <button type="button" class="half-secondary-btn fare-btn btn-secondary" data-toggle="modal" data-target="#schedule_modal">@lang('user.ride.schedule_order')</button>-->
                </form>
            </div>
